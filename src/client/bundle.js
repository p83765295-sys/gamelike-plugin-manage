...
`
    ...
    const zh = {
      ...
      'confirm.deleteGroup': '删除插件包「{name}」？（不会卸载插件，只是移出插件包）',
      'realId': '实际 id: {id}',
      'expand': '展开: {title}',
      'collapse': '折叠: {title}',
      'manage.intro': '禁用/启用直接写 profile 配置（cordis.patch.yml）并热应用，立即生效；卸载/更新写入待重启队列，重启 DSH 后生效；原生插件不可卸载。',
      ...
      'install.allowBuild': '允许执行构建脚本（仅对缺少入口文件 lib/ 或 dist/ 的包生效；会执行该来源的 npm install / 构建脚本，请确认来源可信）',
      'install.local.title': '① 本地目录',
      'install.local.desc': '填写插件项目目录（含 package.json 与 lib/ 或 dist/，支持 Windows 或 WSL 路径），未构建会自动尝试构建。',
      ...
      'packages.intro': '把已安装的用户插件（无论启用/禁用）加入插件包，导出为 .tgz 压缩包。插件包可在「插件安装」Tab 拖入一键安装，安装后自动恢复插件包。',
      'packages.create.title': '① 创建插件包',
      'packages.create.groupNamePlaceholder': '插件包名（例如：工具包 / 面板包）',
      'packages.searchPlaceholder': '搜索插件…',
      'packages.create.groupNameRequired': '请填写插件包名',
      'packages.create.selectRequired': '请先勾选要加入插件包的插件（一个插件可以同时属于多个插件包）',
      'packages.create.hint': '勾选的插件会加入上面填写的插件包；插件可以同时属于多个插件包，导出时交集只内嵌一份。',
      'packages.create.saved': '已保存插件包「{name}」（{count} 个插件；多归属，交集在导出时自动去重）',
      'packages.create.saveFailed': '保存插件包失败',
      'packages.list.title': '② 已有的插件包',
      'packages.list.removeOk': '已从插件包「{group}」移除 {plugin}',
      'packages.list.removeFailed': '移除失败',
      'packages.list.deleted': '已删除插件包「{name}」',
      'packages.list.deleteFailed': '删除插件包失败',
      'packages.list.groupFailed': '插件包操作失败',
      'packages.list.enable': '启用插件包',
      'packages.list.disable': '禁用插件包',
      'packages.list.pendingOk': '已写入待重启队列',
      'packages.list.count': '{count} 个插件',
      'packages.export.title': '③ 导出插件包',
      'packages.export.desc': '导出所有插件包为 .tgz（浏览器下载）。包内含 package.json + manifest.yml + plugins/，可在「插件安装」Tab 拖入安装。',
      'packages.export.packNamePlaceholder': '包名（默认 my-dsh-pack）',
      'packages.export.selectGroups': '选择要导出的插件包（{selected}/{total}）',
      'packages.export.noneSelected': '请至少选择一个要导出的插件包',
      'packages.export.required': '还没有可导出的插件包（请先创建插件包并加入插件）',
      'packages.export.building': '正在打包并下载 {name}.tgz …',
      'packages.export.failed': '导出失败',
      'packages.export.done': '已导出 {name}.tgz（浏览器下载）。可在「插件安装」Tab 拖入该包一键安装，安装后自动恢复插件包。',
      'op.failed': '{label} 失败',
      'list.failed': 'list 失败',
    ...
    const en = {
      ...
      'action.saveGroup': 'Save plugin pack',
      ...
      'confirm.deleteGroup': 'Delete plugin pack "{name}"? (plugins are not uninstalled, only removed from the pack)',
      'realId': 'actual id: {id}',
      'expand': 'Expand: {title}',
      'collapse': 'Collapse: {title}',
      'manage.intro': 'Disable/enable writes the profile patch and hot-applies immediately; uninstall/update is queued and applies after DSH restarts. Native plugins cannot be uninstalled.',
      ...
      'install.allowBuild': 'Allow build scripts (only for packages missing lib/ or dist/ entry; runs the source\'s npm install / build scripts — only for sources you trust)',
      'install.local.title': '① Local directory',
      'install.local.desc': 'Path to a plugin project (with package.json and lib/ or dist/; Windows or WSL paths are supported). Missing entry will attempt a build.',
      ...
      'packages.intro': 'Organize installed user plugins (enabled or disabled) into plugin packs and export them as a .tgz pack. Drop the pack in the Install tab to restore plugin packs automatically.',
      'packages.create.title': '① Create plugin pack',
      'packages.create.groupNamePlaceholder': 'Plugin pack name (e.g. tools / panels)',
      'packages.searchPlaceholder': 'Search plugins…',
      'packages.create.groupNameRequired': 'Please enter a plugin pack name',
      'packages.create.selectRequired': 'Select plugins to add (a plugin may belong to several plugin packs)',
      'packages.create.hint': 'Selected plugins join the plugin pack above; plugins may belong to multiple plugin packs, and export deduplicates intersections into one copy.',
      'packages.create.saved': 'Plugin pack "{name}" saved ({count} plugins; multi-membership, intersections deduplicated on export)',
      'packages.create.saveFailed': 'Failed to save plugin pack',
      'packages.list.title': '② Existing plugin packs',
      'packages.list.removeOk': 'Removed {plugin} from plugin pack "{group}"',
      'packages.list.removeFailed': 'Failed to remove',
      'packages.list.deleted': 'Plugin pack "{name}" deleted',
      'packages.list.deleteFailed': 'Failed to delete plugin pack',
      'packages.list.groupFailed': 'Plugin pack operation failed',
      'packages.list.enable': 'Enable plugin pack',
      'packages.list.disable': 'Disable plugin pack',
      'packages.list.pendingOk': 'Written to the restart queue',
      'packages.list.count': '{count} plugins',
      'packages.export.title': '③ Export pack',
      'packages.export.desc': 'Export all plugin packs as a .tgz download. The pack contains package.json + manifest.yml + plugins/, installable via the Install tab.',
      'packages.export.packNamePlaceholder': 'Pack name (default my-dsh-pack)',
      'packages.export.selectGroups': 'Select plugin packs to export ({selected}/{total})',
      'packages.export.noneSelected': 'Select at least one plugin pack to export',
      'packages.export.required': 'No exportable plugin packs yet (create a plugin pack with plugins first)',
      'packages.export.building': 'Packing and downloading {name}.tgz …',
      'packages.export.failed': 'Export failed',
      'packages.export.done': 'Exported {name}.tgz. Drop it in the Install tab to install and restore plugin packs.',
                        ...
                        jsxs('div', {
                          ...
                          children: [
                            jsx('button', {
                              ...
                              children: t('packages.list.enable'),
                            }),
                            jsx('button', {
                              type: 'button',
                              className: 'pm-btn',
                              ...
                              children: t('packages.list.disable'),
                            }),
                            jsx('button', {
                              type: 'button',
                              className: 'pm-btn pm-btn-danger',
